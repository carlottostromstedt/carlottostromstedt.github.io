...
<p style="margin-top: 40px; font-size: 50px"><i class="fa-solid fa-envelope fa-xl" style="font-size:120px"></i> E-Mail-Anhänge</p>

Anhänge die beim öffnen Schwachstellen in Software (wie Dokumentenlesern) ausnützen, um Malware zu installieren.
</div>
<div>

<p style="margin-top: 40px; font-size: 50px"><i class="fa-solid fa-box fa-xl" style="font-size: 120px"></i> Software-Bündelung / infizierte Downloads</p>
